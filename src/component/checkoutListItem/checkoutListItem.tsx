...
function CheckoutListItem(props:{item:[Number, Number]}) {
    const displayItem = getProduct(props.item[0]);
        ...
        <Col xs={12} className={'d-flex flex-row align-items-center mb-3'}>
            ...
            <InputGroup className="flex-grow-0 mx-3 " style={{maxWidth:150}}>
                <InputGroup.Prepend>
                    <Button 
                        variant="danger"
                        onClick={ () => checkout.removeOne(props.item[0])}
                    >-</Button>
                </InputGroup.Prepend>
                <FormControl 
                    type="text"
                ...
                <InputGroup.Append>
                    <Button 
                        variant="success"
                        onClick={ () => checkout.add(props.item[0])}
                    >+</Button>
                </InputGroup.Append>
            </InputGroup>
            <Button 
                ...
                onClick={ () => checkout.remove(props.item[0])}
            >Remove</Button>
        </Col>
    )
}
